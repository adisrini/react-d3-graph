...
var _graph = require('./graph.renderer');
...
var Graph = (function(_React$Component) {
    ...
    _createClass(Graph, [
        {
            ...
            value: function _graphForcesConfig() {
                ...
                (0, _d3Selection.select)('#' + this.state.id + '-' + _const2.default.GRAPH_WRAPPER_ID)
                    .selectAll('.node')
                    .call(customNodeDrag);
            }
    ...
    function Graph(props) {
        ...
        _this._zoomConfig = function() {
            return (0, _d3Selection.select)('#' + _this.state.id + '-' + _const2.default.GRAPH_WRAPPER_ID).call(
                (0, _d3Zoom.zoom)()
        ...
        _this._zoomed = function() {
            ...
            (0, _d3Selection.selectAll)('#' + _this.state.id + '-' + _const2.default.GRAPH_CONTAINER_ID).attr(
                'transform',
                transform
            );
    ...
    _createClass(Graph, [
        {
            ...
            value: function componentWillReceiveProps(nextProps) {
                ...
                var configUpdated =
                    !_utils2.default.isObjectEmpty(nextProps.config) &&
                    !_utils2.default.isDeepEqual(nextProps.config, this.state.config);
                var state = newGraphElements ? graphHelper.initializeGraphState(nextProps, this.state) : this.state;
                var config = configUpdated
                    ? _utils2.default.merge(_config2.default, nextProps.config || {})
                    : this.state.config;
